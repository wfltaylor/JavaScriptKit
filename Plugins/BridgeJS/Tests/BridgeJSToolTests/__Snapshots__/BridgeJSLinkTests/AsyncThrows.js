...
export async function createInstantiator(options, swift) {
    ...
    return {
        ...
        createExports: (instance) => {
            ...
            const exports = {
                asyncThrowsVoid: function bjs_asyncThrowsVoid() {
                    const ret = instance.exports.bjs_asyncThrowsVoid();
                ...
                asyncThrowsWithResult: function bjs_asyncThrowsWithResult() {
                    const ret = instance.exports.bjs_asyncThrowsWithResult();
                    const ret1 = swift.memory.getObject(ret);
                    swift.memory.release(ret);
                    if (tmpRetException) {
                        const error = swift.memory.getObject(tmpRetException);
